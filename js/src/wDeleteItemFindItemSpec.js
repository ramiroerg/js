/**
* Workflow 
* Create a project, create an item, delete the item, find created item (negative)
** Given I don't have a Project
** When I create an item for this project and delete the item
...
frisby.create('Given I don’t have a Project, Create a new Project')
	...
	.afterJSON(function(data){
		...
		.expectJSON({
			...
			.afterJSON(function(data){
				var ItemId = data.Id;
				frisby.create('Then I will delete the item')
